...
//     header("Location: https://virta-calls.com/login.html");
//     exit();
// }
...
<aside class="sidebar-nav-wrapper">
    <div class="navbar-logo">
        <a href="https://virta-calls.com/dashboard/applicants.php">
    ...
    <nav class="sidebar-nav">
        <ul>
            <li class="nav-item">
                <a href="https://virta-calls.com/dashboard/applicants.php">
                    <span class="text text1">Applicants</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="https://virta-calls.com/dashboard/inquirers.php">
                    <span class="text text2">Inquirers</span>
                </a>
            </li>
            <li class="nav-item">
...
<header class="header">
    ...
    <section class="table-components">
        <div class="container-fluid">
            ...
            <form method="post" action="http://localhost/virta%20calls/dashboard/export.php">
                            ...
                            <div class="table-wrapper table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th><h5><center>Company</center></h5></th>
                                        <th><h5><center>Email</center></h5></th>
                                        <th><h5><center>Phone</center></h5></th>
                                        <th><h5><center>Address</center></h5></th>
                                        <th><h5><center>Industry</center></h5></th>
                                        <th><h5><center>N° employees</center></h5></th>
                                        <th><h5><center>Date</center> </h5></th>
                                        <th><h5><center>Reject</center></h5></th> 
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr id='row_" . $row["id_applicants"] . "'>";
                                            echo "<td><center><p>" . $rowNumber . "</p></center></td>";
                                            echo "<td><center><p>" . $row["company_name"] . "</p></center></td>";
                                            echo "<td><center><p>" . $row["email"] . "</p></center></td>";
                                            echo "<td><center><p>" . $row["phone_number"] . "</p></center></td>";
                                            echo "<td><center><p>" . $row["address"] . "</p></center></td>";
                                            echo "<td><center><p>" . $row["work_field"] . "</p></center></td>";
                                            echo "<td><center><p>" . $row["employees_number"] . "</p></center></td>";
                                            echo "<td><center><p>" . $row["registration_date"] . "</p></center></td>";
                                            echo "<td><button class='delete-btn'>Reject</button></td>"; 
                                            echo "</tr>";
